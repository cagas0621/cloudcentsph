			...
			<div class="row mb-5">
				<div class="col-sm-12 col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2"><a href="#"><img src="<?php bloginfo('template_directory');?>/assets/images/Picture1.png" width="200" alt=""></a>
						</h2>
				...
				<div class="col-sm-12 col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map marker"></span><span class="text">Metro Manila,
										PH</span></li>
