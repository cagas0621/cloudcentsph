...
<div class="hero-wrap" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
		...
		<div class="row no-gutters slider-text align-items-center">
			<div class="col-md-12 ftco-animate d-flex align-items-end">
				<div class="text w-100">
					<p class="mb-4" style="font-size: 50px;"><span style="font-weight: bold; color: #FDBE34; font-size: 60px;">ELEVATE</span> <span>YOUR
							BUSINESS</span></p>
					<p class="mb-4" style="font-size: 50px;"><span style="font-weight: bold; color: #0D3166; font-size: 60px;">EXPAND</span> <span>YOUR
							HORIZONS</span></p>
					<button class="btn1" href="about.html">GET STARTED</button>
		...
		<div class="row d-flex">
			...
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					...
					<div class="media-body py-md-4">
						<h3>COST SAVINGS</h3>
						<p>Outsourcing your bookkeeping with can be way cheaper than hiring a full-time bookkeeper.
							You pay for what you need, no employee benefits, no office space, and no equipment
							costs.
						</p>
					</div>
				</div>
			...
			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate">
				...
				<form action="#" class="appointment">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Comment or Message"></textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
