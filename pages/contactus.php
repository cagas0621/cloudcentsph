<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/images/NEW/contactus.jpg');" data-stellar-background-ratio="0.5">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-4 ftco-animate mb-5 text-center">
                <h1 class="mb-3 bread">Contact us</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo home_url(); ?>">Home <i class="fa fa-chevron-right"></i></a></span> <span>Contact us <i class="fa fa-chevron-right"></i></span></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="wrapper px-md-4">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Address:</span> Unit S13 2nd Floor Robertson Plaza Centennial Rd Tabon I , Kawit, Cavite, 4104</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-5 d-flex align-items-stretch">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3863.86154997513!2d120.89790999678956!3d14.435141300000009!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d2b7b9db452d%3A0x495180265d539ab!2sRobertson%20Plaza!5e0!3m2!1sen!2sph!4v1700038719267!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
